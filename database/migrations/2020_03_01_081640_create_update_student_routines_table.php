...
class CreateUpdateStudentRoutinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('update_student_routines', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('update_student_routines');
    }
}
