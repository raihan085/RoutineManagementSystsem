...
class CreateUpdateStaffRoutinesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('update_staff_routines', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('update_staff_routines');
    }
}
